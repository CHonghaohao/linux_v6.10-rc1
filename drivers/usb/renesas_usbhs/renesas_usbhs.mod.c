...
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g043");
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g043C*");
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g044");
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g044C*");
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g054");
MODULE_ALIAS("of:N*T*Crenesas,usbhs-r9a07g054C*");
...
MODULE_ALIAS("of:N*T*Crenesas,rzg2l-usbhs");
MODULE_ALIAS("of:N*T*Crenesas,rzg2l-usbhsC*");
