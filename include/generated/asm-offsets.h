...
#define TASK_THREAD_RA 2696 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 2704 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 2712 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 2720 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 2728 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 2736 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 2744 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 2752 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 2760 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 2768 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 2776 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 2784 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 2792 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 2800 /* offsetof(struct task_struct, thread.s[11]) */
...
#define TASK_THREAD_F0 2808 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 2816 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 2824 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 2832 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 2840 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 2848 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 2856 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 2864 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 2872 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 2880 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 2888 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 2896 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 2904 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 2912 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 2920 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 2928 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 2936 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 2944 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 2952 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 2960 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 2968 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 2976 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 2984 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 2992 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 3000 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 3008 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 3016 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 3024 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 3032 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 3040 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 3048 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 3056 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 3064 /* offsetof(struct task_struct, thread.fstate.fcsr) */
...
#define KVM_ARCH_GUEST_ZERO 960 /* offsetof(struct kvm_vcpu_arch, guest_context.zero) */
#define KVM_ARCH_GUEST_RA 968 /* offsetof(struct kvm_vcpu_arch, guest_context.ra) */
#define KVM_ARCH_GUEST_SP 976 /* offsetof(struct kvm_vcpu_arch, guest_context.sp) */
#define KVM_ARCH_GUEST_GP 984 /* offsetof(struct kvm_vcpu_arch, guest_context.gp) */
#define KVM_ARCH_GUEST_TP 992 /* offsetof(struct kvm_vcpu_arch, guest_context.tp) */
#define KVM_ARCH_GUEST_T0 1000 /* offsetof(struct kvm_vcpu_arch, guest_context.t0) */
#define KVM_ARCH_GUEST_T1 1008 /* offsetof(struct kvm_vcpu_arch, guest_context.t1) */
#define KVM_ARCH_GUEST_T2 1016 /* offsetof(struct kvm_vcpu_arch, guest_context.t2) */
#define KVM_ARCH_GUEST_S0 1024 /* offsetof(struct kvm_vcpu_arch, guest_context.s0) */
#define KVM_ARCH_GUEST_S1 1032 /* offsetof(struct kvm_vcpu_arch, guest_context.s1) */
#define KVM_ARCH_GUEST_A0 1040 /* offsetof(struct kvm_vcpu_arch, guest_context.a0) */
#define KVM_ARCH_GUEST_A1 1048 /* offsetof(struct kvm_vcpu_arch, guest_context.a1) */
#define KVM_ARCH_GUEST_A2 1056 /* offsetof(struct kvm_vcpu_arch, guest_context.a2) */
#define KVM_ARCH_GUEST_A3 1064 /* offsetof(struct kvm_vcpu_arch, guest_context.a3) */
#define KVM_ARCH_GUEST_A4 1072 /* offsetof(struct kvm_vcpu_arch, guest_context.a4) */
#define KVM_ARCH_GUEST_A5 1080 /* offsetof(struct kvm_vcpu_arch, guest_context.a5) */
#define KVM_ARCH_GUEST_A6 1088 /* offsetof(struct kvm_vcpu_arch, guest_context.a6) */
#define KVM_ARCH_GUEST_A7 1096 /* offsetof(struct kvm_vcpu_arch, guest_context.a7) */
#define KVM_ARCH_GUEST_S2 1104 /* offsetof(struct kvm_vcpu_arch, guest_context.s2) */
#define KVM_ARCH_GUEST_S3 1112 /* offsetof(struct kvm_vcpu_arch, guest_context.s3) */
#define KVM_ARCH_GUEST_S4 1120 /* offsetof(struct kvm_vcpu_arch, guest_context.s4) */
#define KVM_ARCH_GUEST_S5 1128 /* offsetof(struct kvm_vcpu_arch, guest_context.s5) */
#define KVM_ARCH_GUEST_S6 1136 /* offsetof(struct kvm_vcpu_arch, guest_context.s6) */
#define KVM_ARCH_GUEST_S7 1144 /* offsetof(struct kvm_vcpu_arch, guest_context.s7) */
#define KVM_ARCH_GUEST_S8 1152 /* offsetof(struct kvm_vcpu_arch, guest_context.s8) */
#define KVM_ARCH_GUEST_S9 1160 /* offsetof(struct kvm_vcpu_arch, guest_context.s9) */
#define KVM_ARCH_GUEST_S10 1168 /* offsetof(struct kvm_vcpu_arch, guest_context.s10) */
#define KVM_ARCH_GUEST_S11 1176 /* offsetof(struct kvm_vcpu_arch, guest_context.s11) */
#define KVM_ARCH_GUEST_T3 1184 /* offsetof(struct kvm_vcpu_arch, guest_context.t3) */
#define KVM_ARCH_GUEST_T4 1192 /* offsetof(struct kvm_vcpu_arch, guest_context.t4) */
#define KVM_ARCH_GUEST_T5 1200 /* offsetof(struct kvm_vcpu_arch, guest_context.t5) */
#define KVM_ARCH_GUEST_T6 1208 /* offsetof(struct kvm_vcpu_arch, guest_context.t6) */
#define KVM_ARCH_GUEST_SEPC 1216 /* offsetof(struct kvm_vcpu_arch, guest_context.sepc) */
#define KVM_ARCH_GUEST_SSTATUS 1224 /* offsetof(struct kvm_vcpu_arch, guest_context.sstatus) */
#define KVM_ARCH_GUEST_HSTATUS 1232 /* offsetof(struct kvm_vcpu_arch, guest_context.hstatus) */
#define KVM_ARCH_GUEST_SCOUNTEREN 1896 /* offsetof(struct kvm_vcpu_arch, guest_csr.scounteren) */
#define KVM_ARCH_HOST_ZERO 96 /* offsetof(struct kvm_vcpu_arch, host_context.zero) */
#define KVM_ARCH_HOST_RA 104 /* offsetof(struct kvm_vcpu_arch, host_context.ra) */
#define KVM_ARCH_HOST_SP 112 /* offsetof(struct kvm_vcpu_arch, host_context.sp) */
#define KVM_ARCH_HOST_GP 120 /* offsetof(struct kvm_vcpu_arch, host_context.gp) */
#define KVM_ARCH_HOST_TP 128 /* offsetof(struct kvm_vcpu_arch, host_context.tp) */
#define KVM_ARCH_HOST_T0 136 /* offsetof(struct kvm_vcpu_arch, host_context.t0) */
#define KVM_ARCH_HOST_T1 144 /* offsetof(struct kvm_vcpu_arch, host_context.t1) */
#define KVM_ARCH_HOST_T2 152 /* offsetof(struct kvm_vcpu_arch, host_context.t2) */
#define KVM_ARCH_HOST_S0 160 /* offsetof(struct kvm_vcpu_arch, host_context.s0) */
#define KVM_ARCH_HOST_S1 168 /* offsetof(struct kvm_vcpu_arch, host_context.s1) */
#define KVM_ARCH_HOST_A0 176 /* offsetof(struct kvm_vcpu_arch, host_context.a0) */
#define KVM_ARCH_HOST_A1 184 /* offsetof(struct kvm_vcpu_arch, host_context.a1) */
#define KVM_ARCH_HOST_A2 192 /* offsetof(struct kvm_vcpu_arch, host_context.a2) */
#define KVM_ARCH_HOST_A3 200 /* offsetof(struct kvm_vcpu_arch, host_context.a3) */
#define KVM_ARCH_HOST_A4 208 /* offsetof(struct kvm_vcpu_arch, host_context.a4) */
#define KVM_ARCH_HOST_A5 216 /* offsetof(struct kvm_vcpu_arch, host_context.a5) */
#define KVM_ARCH_HOST_A6 224 /* offsetof(struct kvm_vcpu_arch, host_context.a6) */
#define KVM_ARCH_HOST_A7 232 /* offsetof(struct kvm_vcpu_arch, host_context.a7) */
#define KVM_ARCH_HOST_S2 240 /* offsetof(struct kvm_vcpu_arch, host_context.s2) */
#define KVM_ARCH_HOST_S3 248 /* offsetof(struct kvm_vcpu_arch, host_context.s3) */
#define KVM_ARCH_HOST_S4 256 /* offsetof(struct kvm_vcpu_arch, host_context.s4) */
#define KVM_ARCH_HOST_S5 264 /* offsetof(struct kvm_vcpu_arch, host_context.s5) */
#define KVM_ARCH_HOST_S6 272 /* offsetof(struct kvm_vcpu_arch, host_context.s6) */
#define KVM_ARCH_HOST_S7 280 /* offsetof(struct kvm_vcpu_arch, host_context.s7) */
#define KVM_ARCH_HOST_S8 288 /* offsetof(struct kvm_vcpu_arch, host_context.s8) */
#define KVM_ARCH_HOST_S9 296 /* offsetof(struct kvm_vcpu_arch, host_context.s9) */
#define KVM_ARCH_HOST_S10 304 /* offsetof(struct kvm_vcpu_arch, host_context.s10) */
#define KVM_ARCH_HOST_S11 312 /* offsetof(struct kvm_vcpu_arch, host_context.s11) */
#define KVM_ARCH_HOST_T3 320 /* offsetof(struct kvm_vcpu_arch, host_context.t3) */
#define KVM_ARCH_HOST_T4 328 /* offsetof(struct kvm_vcpu_arch, host_context.t4) */
#define KVM_ARCH_HOST_T5 336 /* offsetof(struct kvm_vcpu_arch, host_context.t5) */
#define KVM_ARCH_HOST_T6 344 /* offsetof(struct kvm_vcpu_arch, host_context.t6) */
#define KVM_ARCH_HOST_SEPC 352 /* offsetof(struct kvm_vcpu_arch, host_context.sepc) */
#define KVM_ARCH_HOST_SSTATUS 360 /* offsetof(struct kvm_vcpu_arch, host_context.sstatus) */
#define KVM_ARCH_HOST_HSTATUS 368 /* offsetof(struct kvm_vcpu_arch, host_context.hstatus) */
